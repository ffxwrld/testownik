  ...
  if (state.masteredIds.size === totalUnique && totalUnique > 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-50 dark:bg-black p-6 text-center">
        <div className="w-20 h-20 bg-emerald-100 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400 rounded-3xl flex items-center justify-center text-4xl mb-6 shadow-sm border border-emerald-500/20">
          🎉
        </div>
