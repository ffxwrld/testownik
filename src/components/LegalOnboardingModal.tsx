    ...
    <>
      <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-4 sm:p-6" style={{ perspective: '1000px' }}>
        ...
        <motion.div
          ...
          className="relative w-full max-w-[500px] bg-white/90 dark:bg-zinc-900/90 backdrop-blur-2xl rounded-[32px] p-6 sm:p-10 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.2)] border border-white/40 dark:border-white/10 flex flex-col mt-auto sm:mt-0"
        >
          {/* Top Header & Language Switcher */}
          <div className="flex justify-between items-start w-full mb-8">
            <div className="w-14 h-14 bg-gradient-to-br from-primary-100 to-primary-50 dark:from-primary-900/40 dark:to-primary-900/10 text-primary-600 dark:text-primary-400 rounded-2xl flex items-center justify-center shadow-inner border border-white/50 dark:border-white/5">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100/80 dark:bg-zinc-800/80 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-600 dark:text-zinc-300 text-xs font-medium transition-colors backdrop-blur-md"
            >
          ...
          <div className="flex flex-col mb-10">
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-3 tracking-tight" style={{ fontOpticalSizing: 'auto' }}>
          ...
          <div className="space-y-1 mb-10">
            <div className="flex items-center justify-between gap-4 p-4 rounded-2xl bg-zinc-50/50 dark:bg-zinc-800/30 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors border border-transparent dark:border-zinc-800/50">
              <div className="flex-1 text-[15px] text-zinc-700 dark:text-zinc-200 leading-snug">
          ...
          <motion.button
            ...
            className={`
              w-full flex items-center justify-center gap-2 py-4 rounded-2xl text-[17px] font-semibold transition-all duration-300
              ${allAccepted 
